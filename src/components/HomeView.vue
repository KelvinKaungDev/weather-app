<template>
    <div :class="theme ? 'dark' : 'light'">
        <nav class="border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900 pt-5 pb-5">
            <div class="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div class="flex md:order-2 text-gray-500 cursor-pointer">
                    <div class="flex items-center border-l border-slate-200 ml-6 pl-6 dark:border-slate-500 ">
                    </div>
                    <div v-if="theme" class="flex" @click="toggleTheme()">
                    ...
                    <div v-else  @click="toggleTheme()" class="flex">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <div class="grid w-full md:grid-cols-2 mt-20 justify-items-center">
            ...
            <div class="border-2 border-white-500 p-8 text-animation" v-if="showData">
            ...
            <div class="p-8 text-animation" v-else>
                <p class="text-4xl mt-28 text-white text-center">
                    Welcome to <span class="border-b-4 dark:text-red-500">Kelvin Weather Focus</span>
                </p>
